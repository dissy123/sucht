    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="form-inline" role="form">
                ...
                <div class="input-group">
                    <asp:TextBox class="form-control" placeholder="Vorname" ID="input_search_vorname" CausesValidation="false"  runat="server" OnTextChanged="input_search_vorname_TextChanged"></asp:TextBox>
                </div>

                <div class="input-group">
                    <asp:Label class="sr-only" ID="label_suche2" runat="server" Text="Nachname" for="input_search_nachname"></asp:Label>
                    <asp:TextBox class="form-control" placeholder="Nachname" ID="input_search_nachname" CausesValidation="false" runat="server" OnTextChanged="input_search_vorname_TextChanged"></asp:TextBox>
                </div>
            </div>
            <div class="table-responsive">
                <asp:GridView ID="GVKlienten" runat="server" CssClass="table table-striped"
                    ...
                    EmptyDataText="Keine Klienten in der Datenbank" OnRowDeleting="GVKlienten_RowDeleting" OnRowEditing="GVKlienten_RowEditing">
                    <Columns>
                        ...
                        <asp:ImageField DataImageUrlField="avatar" HeaderText=" " ItemStyle-Width="50px" ControlStyle-Width="50px">
                        </asp:ImageField>
